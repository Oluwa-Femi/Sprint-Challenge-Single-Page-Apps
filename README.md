...
> Answer:
Client-side routing reduces the number of times requests go back to the server thereby reducing load time and optimizing user experience. No full page reload is required.
## Project Set Up
